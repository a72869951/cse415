...
TIME_PER_MOVE = 1.5   # Default time limit is one second.
...
if len(sys.argv) > 1:
    ...
    # import Markun_BC_Player as player1
    # import Markun_BC_Player as player2
    import Thanos_BC_Player as player1
    import Thanos_BC_Player as player2
