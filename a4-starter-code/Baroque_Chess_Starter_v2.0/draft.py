"""
designed by Junhao Zeng and JingQiang Wang
CSE415 Project Option 1
May/12/2019
"""
...
def introduce():
    introduction = "My name is Thanos, my designer is JingQiang Wang and Junhao Zeng "
    return introduction
...
def parameterized_minimax(currentState, alphaBeta=False, ply=3, useBasicStaticEval=True):
    global N_STATES_EXPANDED
    global N_STATIC_EVALS
    global N_CUTOFFS
    initTime=time.clock()
    ...
    return {'CURRENT_STATE_STATIC_VAL': CURRENT_STATE_STATIC_VAL, 'N_STATES_EXPANDED':N_STATIC_EVALS , 'N_STATIC_EVALS': 1, 'N_CUTOFFS': N_CUTOFFS}
