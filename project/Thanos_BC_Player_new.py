...
def minimax(state,initTime, timeLimit,plyLeft):
    ...
    # N_STATIC_EVALS=0
    N_CUTOFFS=0
    return minimax_search(state, state, "", 1, initTime, timeLimit, plyLeft, alphaBeta=False, useBasicStaticEval=False,zobristHash=False)
...
def makeMove(currentState, currentRemark, timelimit=10):
    ...
    print("state value",tempBestState[0])

    if currentState.whose_move== WHITE and staticEval(tempBestState[2])>staticEval(currentState):
        print(staticEval(tempBestState[2]),"tempBestState",staticEval(currentState),"currentState")
        # print("!!!!!!!!!!!!!!!!!!!!!!")
        remarks="Your piece turns to dust under my power"
    if currentState.whose_move== BLACK and staticEval(tempBestState[2])<staticEval(currentState):
        remarks="Your piece turns to dust under my power"
        # print("!!!!!!!!!!!!!!!!!!!!!!")
        print(staticEval(tempBestState[2]),"tempBestState",staticEval(currentState),"currentState")
